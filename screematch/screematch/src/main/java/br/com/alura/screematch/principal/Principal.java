...
public class Principal {
    ...
    public void exibeMenu(){
		...
		for (int i = 1; i<=dados.totalTemporas(); i++){
        ...
        for (int i = 0; i < dados.totalTemporas(); i++){
...
//
//        List<String> nomes = Arrays.asList("WES", "Galdo", "Marcola", "Danilo");
//
//        nomes.stream().sorted().limit(3).filter(n -> n.startsWith("M")).map(n -> n.toLowerCase()).forEach(System.out::println);
...
//
//        var techoTitulo = leitura.nextLine();
//
//        Optional<Episodio> episodioBuscado = episodios.stream()
//                .filter(e -> e.getTitulo().toUpperCase().contains(techoTitulo.toUpperCase()))
//                .findFirst();
//        if (episodioBuscado.isPresent()){
//            System.out.println("Episódio encontrado!");
//            System.out.println("Temporada: " + episodioBuscado.get().getTemporada());
//        } else {
//            System.out.println("Não encontramos o episódio!");
//        }
//
